...
-- Updated to work without the ICS generation function
...
-- Step 8: Check available inventory items
...
SELECT '1. Run database/unified-ics-number-generation.sql to set up ICS number generation' as step_1;
SELECT '2. Try creating a custodian slip again' as step_2;
