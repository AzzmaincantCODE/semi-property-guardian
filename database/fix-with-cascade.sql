-- Fix for ambiguous slip_id reference with proper cascade handling
-- This will handle dependent objects properly
...
-- Step 2: Drop the functions with CASCADE to handle any remaining dependencies
...
-- Step 7: Recreate the view that was dropped
