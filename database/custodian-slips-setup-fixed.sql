-- Custodian Slips Tables Setup (Fixed)
-- Run this in Supabase SQL Editor

-- Drop existing tables if they exist (to avoid conflicts)
drop table if exists public.custodian_slip_items;
drop table if exists public.custodian_slips;

-- Create custodian_slips table with text fields for names
create table public.custodian_slips (
...
create table public.custodian_slip_items (
  id uuid primary key default uuid_generate_v4(),
