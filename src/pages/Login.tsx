...
import { AlertCircle, CheckCircle2, Lock, Mail, LogIn, UserPlus } from "lucide-react";
          ...
          <CardContent className="space-y-6">
            ...
            {success && (
              <Alert className="border-green-300 bg-green-50">
                ...
                <AlertDescription className="text-green-800 font-medium">
                  {isSignUp ? "Account created! Sign in now." : "Login successful! Redirecting..."}
                </AlertDescription>
              </Alert>
            )}
            ...
            <div className="pt-4 border-t border-slate-200">
              <Button
                type="button"
                variant="ghost"
                className="w-full text-slate-700 hover:text-purple-600 font-medium"
                onClick={() => {
              ...
              >
                {isSignUp ? (
                  <>Already have an account? <span className="text-purple-600 ml-1">Sign In</span></>
                ) : (
                  <>Don't have an account? <span className="text-purple-600 ml-1">Sign Up</span></>
                )}
              </Button>
            </div>
